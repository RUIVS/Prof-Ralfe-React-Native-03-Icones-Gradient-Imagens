...
function Inicial({ navigation }) {
    ...
    return (
        <View style={estiloInicial.container}>
            ...
            <ImageBackground source={require('../../../assets/imagens/aurelionsol.jpg')} style={estiloInicial.fundo}>


                    <TouchableOpacity onPress={abrirColecao}>
                        <ImageBackground source={require('../../../assets/imagens/Skins-PsyOps.jpg')} style={estiloInicial.botaoBackground}>
